...
document.head.innerHTML+=`<style>div.article-board.m-tcol-c{a.article:visited{color:#d3d3d3 !important;}}</style>
<style>a.article:visited, a.tit:visited{color:#d3d3d3 !important;}</style>
...
<style>tr.board-notice.type_menu{a.article:visited{color:#FFD2D2 !important;}}</style>
